...
public static class PersistenceSetup
{
                                            ...
                                            bool isDev)
    {
        ...
        services.AddScoped<ITransactionProvider>(sp => sp.GetRequiredService<UnitOfWork>());
        services.AddScoped<IUnitOfWork>(sp => sp.GetRequiredService<UnitOfWork>());
    }

    private static void ConfigureDatabase(IServiceCollection services, IConfiguration configuration, bool isDev)
    {
                                                       ...
                                                       bool sensitiveDataLogging)
    {
        optionsBuilder.UseNpgsql(connectionString,
                                 options => options
                                            .UseNodaTime()
                                            .MigrationsHistoryTable(MigrationHistoryTable, DatabaseContext.SchemaName))
